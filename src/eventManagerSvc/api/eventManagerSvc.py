...
from ..models.eventManager import AddPlayerToEvent, PlayerInfo, FullEventInfo, UpdatePlayerPoints
...
@router.delete('remove-player/{event_id}/{player_id}', response_model = FullEventInfo)
